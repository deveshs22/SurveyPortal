...
namespace HPPortal.Web.InterpretationDetails
{
    public partial class Insert : System.Web.UI.Page
    {
        ...
        // This is the Insert method to insert the entered InterpretationDetail item
        // USAGE: <asp:FormView InsertMethod="InsertItem">
        public void InsertItem()
        {
            using (_db)
            {
                var item = new SurveyPortal.Data.Models.InterpretationDetail();
                ...
                {
                    // Save changes
                    _db.InterpretationDetails.Add(item);
                    _db.SaveChanges();
