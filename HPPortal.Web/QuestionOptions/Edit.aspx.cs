...
namespace HPPortal.Web.QuestionOptions
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        public void UpdateItem(int  QuestionOptionId)
        {
            using (_db)
            {
                ...
                if (item == null)
                {
                    ...
                    ModelState.AddModelError("", String.Format("Item with id {0} was not found", QuestionOptionId));
                    return;
                }
        ...
        public SurveyPortal.Data.Models.QuestionOption GetItem([FriendlyUrlSegmentsAttribute(0)]int? QuestionOptionId)
        {
            ...
            using (_db)
            {
                return _db.QuestionOptions.Find(QuestionOptionId);
            }
        }
