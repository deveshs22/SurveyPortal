...
namespace HPPortal.Web.SurveyInterpretations
{
    public partial class Insert : System.Web.UI.Page
    {
        ...
        // This is the Insert method to insert the entered SurveyInterpretation item
        // USAGE: <asp:FormView InsertMethod="InsertItem">
        public void InsertItem()
        {
            using (_db)
            {
                var item = new SurveyPortal.Data.Models.SurveyInterpretation();
                ...
                {
                    // Save changes
                    _db.SurveyInterpretations.Add(item);
                    _db.SaveChanges();
