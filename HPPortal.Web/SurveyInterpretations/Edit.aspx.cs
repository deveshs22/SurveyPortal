...
namespace HPPortal.Web.SurveyInterpretations
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        // This is the Update methd to update the selected SurveyInterpretation item
        // USAGE: <asp:FormView UpdateMethod="UpdateItem">
        public void UpdateItem(int  SurveyInterpretationId)
        {
            using (_db)
            {
                ...
                if (item == null)
                {
                    ...
                    ModelState.AddModelError("", String.Format("Item with id {0} was not found", SurveyInterpretationId));
                    return;
                }
        ...
        // This is the Select method to selects a single SurveyInterpretation item with the id
        ...
        public SurveyPortal.Data.Models.SurveyInterpretation GetItem([FriendlyUrlSegmentsAttribute(0)]int? SurveyInterpretationId)
        {
            ...
            using (_db)
            {
                return _db.SurveyInterpretations.Find(SurveyInterpretationId);
            }
        }
