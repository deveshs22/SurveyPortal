...
namespace HPPortal.Web.SurveySections
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        // This is the Update methd to update the selected SurveySection item
        // USAGE: <asp:FormView UpdateMethod="UpdateItem">
        public void UpdateItem(int  SurveySectionId)
        {
            using (_db)
            {
                ...
                if (item == null)
                {
                    ...
                    ModelState.AddModelError("", String.Format("Item with id {0} was not found", SurveySectionId));
                    return;
                }
        ...
        // This is the Select method to selects a single SurveySection item with the id
        ...
        public SurveyPortal.Data.Models.SurveySection GetItem([FriendlyUrlSegmentsAttribute(0)]int? SurveySectionId)
        {
            ...
            using (_db)
            {
                return _db.SurveySections.Find(SurveySectionId);
            }
        }
